...
class MovieSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Movie
        fields = '__all__'
        # read_only_fields = ('movie_id', 'release_date', 'genres', 'actors', 'like_movie_users_count', 'dislike_movie_users_count', 'watching_movie_users_count', 'favorite_movie_users_count', 'review_movie_count')
