...
class Review(models.Model):
    ...
    # 게시글이 달린 영화
    write_review_movie = models.ForeignKey(
        'MOVIES.Movie', on_delete=models.CASCADE, related_name='write_movie_review', null=True, blank=True)
    # 게시글을 작성한 사용자
    write_review_user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='write_review')
    # 게시글을 좋아요한 사용자
...
class Comment(models.Model):
    ...
    # 댓글 작성자
    write_comment_user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='write_comment')
    # 상위 댓글
    super_comment = models.ForeignKey(
        'self', on_delete=models.CASCADE, related_name='commented', null=True, blank=True)
    # 댓글을 좋아요한 사용자
