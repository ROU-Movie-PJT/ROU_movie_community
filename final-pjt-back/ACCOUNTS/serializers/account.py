...
class ProfileSerializer(UserDetailsSerializer):
    ...
    class Meta:
        ...
        fields = ('id' , 'followers', 'username', 'profile', 'sex', 'birth_date', 'followings', 'hate_genres', )
...
# 싫어하는 장르 조회
class HateGerneSerializer(serializers.ModelSerializer):
...
class UserProfileSerializer(UserDetailsSerializer):
    ...
    class Meta:
        model = User
        fields = ('id' ,'username', 'profile', 'birth_date', 'sex', 'birth_date', 'followings', 'hate_genres', )
